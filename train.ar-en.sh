...
fairseq-preprocess \
    ...
    --trainpref $TEXT/train$SPLIT --validpref $TEXT/valid --testpref $TEXT/test \
    --destdir ar-en-$SPLIT/data-bin --thresholdtgt 0 --thresholdsrc 0 \
    --srcdict ar-en-3M/data-bin/dict.ar.txt \
    --tgtdict ar-en-3M/data-bin/dict.en.txt \
    --workers 64
...
fairseq-train ar-en-$SPLIT/data-bin \
    --source-lang ar \
    --target-lang en \
