...
fairseq-preprocess \
    ...
    --trainpref $TEXT/train$SPLIT --validpref $TEXT/valid --testpref $TEXT/test \
    --destdir vi-en-$SPLIT/data-bin --thresholdtgt 0 --thresholdsrc 0 \
    --srcdict vi-en-3M/data-bin/dict.vi.txt \
    --tgtdict vi-en-3M/data-bin/dict.en.txt \
    --workers 64
...
fairseq-train vi-en-$SPLIT/data-bin \
    --source-lang vi \
    --target-lang en \
