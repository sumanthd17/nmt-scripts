...
fairseq-preprocess \
    ...
    --trainpref $TEXT/train$SPLIT --validpref $TEXT/valid --testpref $TEXT/test \
    --destdir ta-en-$SPLIT/data-bin --thresholdtgt 0 --thresholdsrc 0 \
    --srcdict ta-en-3M/data-bin/dict.ta.txt \
    --tgtdict ta-en-3M/data-bin/dict.en.txt \
    --workers 64
...
fairseq-train ta-en-$SPLIT/data-bin \
    --source-lang ta \
    --target-lang en \
