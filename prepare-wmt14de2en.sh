...
with open('wmt14_en_de/tmp/train.en', 'r') as f:
    src = f.readlines()

with open('wmt14_en_de/tmp/train.de', 'r') as f:
    tgt = f.readlines()
...
# create 500k dataset
with open('wmt14_en_de/tmp/train500k.en', 'w') as f:
...
# create 1M dataset
with open('wmt14_en_de/tmp/train1M.en', 'w') as f:
...
# create 3M dataset
with open('wmt14_en_de/tmp/train3M.en', 'w') as f:
...
with open('wmt14_en_de/train500k.de', 'w') as f:
...
with open('wmt14_en_de/train1M.de', 'w') as f:
...
with open('wmt14_en_de/train3M.de', 'w') as f:
