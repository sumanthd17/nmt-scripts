...
fairseq-preprocess \
    ...
    --trainpref $TEXT/train$SPLIT --validpref $TEXT/valid --testpref $TEXT/test \
    --destdir hi-en-$SPLIT/data-bin --thresholdtgt 0 --thresholdsrc 0 \
    --srcdict hi-en-3M/data-bin/dict.hi.txt \
    --tgtdict hi-en-3M/data-bin/dict.en.txt \
    --workers 64
...
fairseq-train hi-en-$SPLIT/data-bin \
    --source-lang hi \
    --target-lang en \
